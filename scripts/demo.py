...
def main() -> int:
    ...
    print("  NEXT — run this:")
    print()
    print("      make drill FILE=sql/drills/01_window_functions.sql")
    print()
    print("  It shows how the underperforming inverter above was found:")
    print("  ranking, top-N per group, and peer comparison, with the SQL")
    print("  explained line by line.")
    print()
    print("  After that, LEARNING.md has a six-week track.")
    print(f"{line}\n")
